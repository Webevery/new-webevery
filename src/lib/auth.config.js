export const authConfig = {
    ...
    callbacks: {
        ...
        authorized({ auth, request }) {
            ...
            const isOnAdminPages = request.nextUrl?.pathname.startsWith('/dashboard/blogs') || request.nextUrl?.pathname.startsWith('/dashboard/team') || request.nextUrl?.pathname.startsWith('/dashboard/projects') || request.nextUrl?.pathname.startsWith('/dashboard/services');
