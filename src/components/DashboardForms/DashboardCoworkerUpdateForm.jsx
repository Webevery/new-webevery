...
const DashboardCoworkerUpdateForm = ({ data, mutate, slugsArr }) => {
  const { isShown, name, nameEn, photo, position, positionEn, slug } = data;
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      slug !== forSendData.slug
        ? router.push(`/dashboard/team/${forSendData.slug}`)
        : mutate();
    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.newPositionEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.newPosition?.message}</p>
        </div>
