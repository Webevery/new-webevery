...
const DashboardBlogCreateForm = ({ mutate, slugsArr }) => {
  ...
  const onSubmitBlock = (data) => {
    setMainValues("blocks", [...getMainValues("blocks"), data]);
  ...
  return (
    <div className={styles.container}>
      <form
        ...
        noValidate
      >
        <h3 className={styles.formTitle}>Creating new blog</h3>

        <div className={styles.checkboxInputGroup}>
          <label htmlFor="isShown" className={styles.checkboxLabel}>
          ...
          <input
            ...
            id="isShown"
            // placeholder=" "
            {...mainRegister("isShown")}
          />
          <p className={styles.error}>{mainErrors.isShown?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.titleEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.mainTextEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.mainText?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.mainImage?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.directionEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.direction?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.epilogueEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.epilogue?.message}</p>
        </div>
