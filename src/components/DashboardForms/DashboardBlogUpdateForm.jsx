...
const DashboardBlogUpdateForm = ({ data, mutate, slugsArr }) => {
  ...
  const onSubmitMain = async (data) => {
    ...
    try {
      ...
      slug !== forSendData.slug
        ? router.push(`/dashboard/blog/${forSendData.slug}`)
        : mutate();
  ...
  const onSubmitBlock = (data) => {
    ...
    setMainValues("newBlocks", [...currentBlocks]);
    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.checkboxInputGroup}>
          ...
          <input
            ...
            id="newIsShown"
            // placeholder=" "
            {...mainRegister("newIsShown")}
          />
          <p className={styles.error}>{mainErrors.newIsShown?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newSlug?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newTitleEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newTitle?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newMainTextEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newMainText?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          <CldUploadButton
            ...
            onUpload={(result, widget) => {
              ...
              setMainValues("newMainImage", result.info.public_id, {
                shouldValidate: true,
              });
              widget.close();
          ...
          <p className={styles.error}>{mainErrors.newMainImage?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          />
          <label htmlFor="newDirectionEn" className={styles.formLabel}>
            DirectionEn
          </label>
          <p className={styles.error}>{mainErrors.newDirectionEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newDirection?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newEpilogueEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{mainErrors.newEpilogue?.message}</p>
        </div>
      ...
      >
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{blockErrors.subTitleEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{blockErrors.subTitle?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{blockErrors.textEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{blockErrors.rangeNumber?.message}</p>
        </div>
