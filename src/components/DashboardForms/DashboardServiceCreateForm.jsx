...
const DashboardServiceCreateForm = ({ mutate, slugsArr }) => {
  const initialValues = {
    defaultValues: {
      isShown: false,
      title: "",
  ...
  return (
    <div className={styles.container}>
      <form
        ...
        noValidate
      >
        <h3 className={styles.formTitle}>Creating new service</h3>
        ...
        <div className={styles.inputGroup}>
          ...
          />
          <label htmlFor="titleGradientEn" className={styles.formLabel}>
            Title GradientEn
          </label>
          <p className={styles.error}>{errors.titleGradientEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.titleGradient?.message}</p>
        </div>
        <div className={styles.inputGroup}>
          <CldUploadButton
            name="mockup"
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.directionsEn?.message}</p>
        </div>
