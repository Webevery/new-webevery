  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      slug !== forSendData.slug
        ? router.push(`/dashboard/services/${forSendData.slug}`)
        : mutate();
    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.newDescriptionEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          />
          <label htmlFor="newDirectionsEn" className={styles.formLabel}>
            New DirectionsEn
          </label>
          <p className={styles.error}>{errors.newDirectionsEn?.message}</p>
        </div>
        ...
        <div className={styles.inputGroup}>
          ...
          <p className={styles.error}>{errors.newDirections?.message}</p>
        </div>
