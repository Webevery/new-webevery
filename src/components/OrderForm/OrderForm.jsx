  ...
  return (
    <>
      {isSubmited && isModalOpen && !isFooterForm ? (
        <SuccessContent isSubmited={isSubmited} closeModal={closeModal} />
      ) : (
        <div
          className={
            isFooterForm
        ...
        >
          ...
          {!isFooterForm && (
            <div className={`${styles.titleWrap} ${titleClassName}`}>
              {isMobile || isTablet ? (
          ...
          >
            <div
              className={
                isFooterForm ? styles.inputHolderFooter : styles.inputHolder
              }
            >
