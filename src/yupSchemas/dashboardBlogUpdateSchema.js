...
export const dashboardBlogUpdateSchema = yup.object({
  ...
  newTitleEn: yup.string().required("NewTitleEn is required"),
  newMainImage: yup.string().required("NewMainImage is required"),
  newMainText: yup.string().required("NewMainText is required"),
  newMainTextEn: yup.string().required("NewMainTextEn is required"),
  newDirection: yup.string().required("NewDirections is required"),
  newDirectionEn: yup.string().required("NewDirectionsEn is required"),
  newEpilogue: yup.string().required("NewEpilogue is required"),
  newEpilogueEn: yup.string().required("NewEpilogueEn is required"),
  newBlocks: yup.array().min(1, "At least one NewBlocks"),
  newSlug: yup
    .string()
